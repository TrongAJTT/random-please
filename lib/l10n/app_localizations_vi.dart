...
class AppLocalizationsVi extends AppLocalizations {
  ...
  String get dateCalculatorDesc =>
      'Một công cụ linh hoạt để xử lý mọi tính toán liên quan đến ngày tháng của bạn. Dưới đây là tổng quan về các tính năng của nó:';

  @override
  String get dateInfoTabDescription =>
      'Cung cấp thông tin chi tiết cho một ngày bất kỳ, bao gồm thứ trong tuần, ngày trong năm, số tuần, quý và trạng thái năm nhuận.';

  @override
  String get dateDifferenceTabDescription =>
      'Tính toán khoảng thời gian giữa hai ngày, hiển thị kết quả dưới dạng kết hợp năm, tháng, ngày, cũng như trong các đơn vị tổng cộng như tháng, tuần, ngày, v.v.';

  @override
  String get addSubtractTabDescription =>
      'Thêm hoặc bớt một số năm, tháng, và ngày cụ thể từ một ngày cho trước để xác định ngày kết quả.';

  @override
  String get ageCalculatorTabDescription =>
      'Tính tuổi từ ngày sinh và hiển thị tổng số ngày đã sống, số ngày còn lại đến sinh nhật tiếp theo và ngày sinh nhật tiếp theo.';
  ...
  String get ageCalculatorDesc =>
      'Tính tuổi và theo dõi các ngày sinh nhật sắp tới.';
  ...
  String get dateInfoDesc =>
      'Nhận thông tin chi tiết về bất kỳ ngày nào được chọn';
  ...
  String get quickActionsDesc =>
      'Tùy chỉnh các phím tắt xuất hiện khi bạn nhấn giữ biểu tượng ứng dụng.';
  ...
  String get toolVisibilityChanged =>
      'Thứ tự và hiển thị công cụ đã được cập nhật.';
  ...
  String get bmiUnderweightRec1 =>
      'Tăng lượng calo nạp vào với thực phẩm bổ dưỡng, nhiều calo';

  @override
  String get bmiUnderweightRec2 =>
      'Bao gồm chất béo lành mạnh, protein và carbohydrate phức tạp trong chế độ ăn';

  @override
  String get bmiUnderweightRec3 =>
      'Tham khảo ý kiến nhà cung cấp chăm sóc sức khỏe để loại trừ các vấn đề sức khỏe tiềm ẩn';

  @override
  String get bmiNormalRec1 =>
      'Duy trì chế độ ăn cân bằng với nhiều loại chất dinh dưỡng';

  @override
  String get bmiNormalRec2 =>
      'Tiếp tục hoạt động thể chất thường xuyên và thói quen tập thể dục';

  @override
  String get bmiNormalRec3 =>
      'Theo dõi cân nặng thường xuyên để duy trì trong phạm vi khỏe mạnh';

  @override
  String get bmiOverweightRec1 =>
      'Tạo ra sự thiếu hụt calo vừa phải thông qua chế độ ăn và tập thể dục';

  @override
  String get bmiOverweightRec2 =>
      'Tập trung vào kiểm soát khẩu phần và chọn thực phẩm giàu chất dinh dưỡng';

  @override
  String get bmiOverweightRec3 =>
      'Tăng hoạt động thể chất với cả cardio và tập luyện sức mạnh';

  @override
  String get bmiObeseRec1 =>
      'Làm việc với các chuyên gia chăm sóc sức khỏe để phát triển kế hoạch giảm cân an toàn';

  @override
  String get bmiObeseRec2 =>
      'Cân nhắc thay đổi lối sống toàn diện bao gồm chế độ ăn và tập thể dục';

  @override
  String get bmiObeseRec3 =>
      'Có thể cần thiết theo dõi y tế thường xuyên để có sức khỏe tối ưu';

  @override
  String get bmiUnderweightDesc =>
      'Có thể chỉ ra suy dinh dưỡng, rối loạn ăn uống, hoặc các vấn đề sức khỏe tiềm ẩn';
  ...
  String get cacheTypeCalculatorToolsDesc =>
      'Lịch sử tính toán, dữ liệu máy tính đồ thị, dữ liệu BMI và cài đặt';
  ...
  String get multipleCardsDesc =>
      'Tạo nhiều thẻ chuyển đổi, mỗi thẻ có bộ tiền tệ và số tiền riên.';
  ...
  String get focusModeEnabledDesc =>
      'Ẩn các thành phần UI để tập trung không bị phân tâm';
  ...
  String get useJoystickToNavigateGraph =>
      'Sử dụng joystick để điều hướng đồ thị';
  ...
  String get bmiUnderweightInterpretation =>
      'Chỉ số BMI của bạn cho thấy bạn bị thiếu cân. Điều này có thể gợi ý bạn cần tăng cân để có sức khỏe tối ưu.';

  @override
  String get bmiElderlyNote =>
      'Đối với người trên 65 tuổi, phạm vi BMI hơi cao hơn (22-27) có thể được chấp nhận và có tác dụng bảo vệ.';

  @override
  String get bmiYouthNote =>
      'Đối với người dưới 20 tuổi, BMI nên được đánh giá bằng biểu đồ phần trăm theo tuổi và giới tính.';

  @override
  String get bmiLimitationReminder =>
      'Lưu ý: BMI chỉ là công cụ sàng lọc và không tính đến khối lượng cơ, mật độ xương hay thành phần cơ thể.';

  @override
  String get bmiElderlyRec =>
      'Là người lớn tuổi, hãy tập trung duy trì khối lượng cơ thông qua tập luyện sức bền và đủ protein.';

  @override
  String get bmiYouthRec =>
      'Đối với thanh niên, hãy tập trung xây dựng thói quen ăn uống lành mạnh và hoạt động thể chất thường xuyên.';

  @override
  String get bmiFemaleRec =>
      'Phụ nữ trong độ tuổi sinh sản nên đảm bảo dinh dưỡng đầy đủ, đặc biệt là sắt và canxi.';

  @override
  String get bmiConsultationRec =>
      'Cân nhắc tham khảo ý kiến chuyên gia y tế để được đánh giá sức khỏe và hướng dẫn cá nhân hóa.';
  ...
  String get bmiLimitation1 =>
      'Không phản ánh thành phần cơ thể (tỷ lệ cơ bắp/mỡ)';

  @override
  String get bmiLimitation2 =>
      'Có thể không chính xác cho vận động viên, người già, hoặc một số nhóm dân tộc';

  @override
  String get bmiLimitation3 =>
      'Không đánh giá các yếu tố sức khỏe khác như huyết áp, cholesterol, đường huyết';

  @override
  String get bmiLimitation4 =>
      'Không phù hợp cho phụ nữ mang thai, trẻ em dưới 18 tuổi, hoặc người có bệnh lý nhất định';

  @override
  String get bmiConsult1 =>
      'Khám sức khỏe toàn diện và làm các xét nghiệm cần thiết';

  @override
  String get bmiConsult2 =>
      'Tham khảo ý kiến chuyên gia y tế và được hướng dẫn';

  @override
  String get bmiConsult3 =>
      'Nhận tư vấn và hướng dẫn chăm sóc phù hợp từ bác sĩ chuyên khoa';

  @override
  String get bmiPediatricTitle =>
      'Phân loại BMI cho Trẻ em và Thanh thiếu niên (Dưới 18 tuổi)';
  ...
  String get bmiPercentileNote =>
      'Dựa trên biểu đồ tăng trưởng CDC với phần trăm phân vị theo tuổi và giới tính';
  ...
  String get bmiPediatricNote =>
      'Đối với trẻ em và thanh thiếu niên, BMI được so sánh với những người cùng tuổi và giới tính bằng biểu đồ phân vị.';

  @override
  String get bmiGrowthPattern =>
      'Tham khảo ý kiến bác sĩ nhi khoa để đánh giá mô hình tăng trưởng và sức khỏe tổng thể.';
  ...
  String get financialCalculatorDesc =>
      'Tính toán tài chính nâng cao cho vay, đầu tư và lãi kép';
  ...
  String get financialCalculatorOverview =>
      'Máy tính tài chính toàn diện cho thanh toán vay, kế hoạch đầu tư và tính toán lãi kép';
  ...
  String get pleaseEnterValidNumbers =>
      'Vui lòng nhập các số dương hợp lệ cho tất cả các trường.';

  @override
  String get pleaseEnterValidReturnAndTerm =>
      'Vui lòng nhập các số dương hợp lệ cho tỷ lệ lợi nhuận và thời hạn.';

  @override
  String get financialCalculationHistory =>
      'Lịch sử tính toán tài chính và các phép tính đã lưu';
  ...
  String get confirmClearFinancialHistory =>
      'Bạn có chắc chắn muốn xóa tất cả lịch sử tính toán tài chính không?';
  ...
  String get investmentCalculationSaved =>
      'Phép tính đầu tư đã được lưu vào lịch sử';

  @override
  String get compoundCalculationSaved =>
      'Phép tính lãi kép đã được lưu vào lịch sử';
  ...
  String get startCalculatingHint =>
      'Bắt đầu thực hiện tính toán tài chính để xem chúng tại đây';
  ...
  String get loanCalculationDesc =>
      'Tính toán thanh toán hàng tháng, tổng chi phí và lãi cho các khoản vay';

  @override
  String get investmentCalculationDesc =>
      'Lập kế hoạch giá trị tương lai của đầu tư với đóng góp thường xuyên';

  @override
  String get compoundInterestDesc =>
      'Tính toán tăng trưởng lãi kép theo thời gian';
  ...
  String get financialApplicationsDesc =>
      'Kế hoạch thế chấp, vay mua xe, tiết kiệm hưu trí, quỹ giáo dục, đầu tư kinh doanh và lập kế hoạch tài chính tổng thể.';
  ...
  String get financialTip1 =>
      'So sánh các thời hạn vay khác nhau để tìm lựa chọn tốt nhất';
  ...
  String get financialTip4 =>
      'Đóng góp thường xuyên có thể tăng đáng kể tăng trưởng đầu tư';
  ...
  String get dateCalculatorInfoHeaderSubtitle =>
      'Công cụ mạnh mẽ cho mọi phép tính về ngày tháng và thời gian.';
  ...
  String get dateCalculatorOverview =>
      'Công cụ toàn diện cho mọi phép tính về ngày tháng, thời gian và tuổi với nhiều tính năng hữu ích';
  ...
  String get comprehensiveDateCalcDesc =>
      'Hỗ trợ đầy đủ các phép tính về ngày tháng, thời gian và tuổi';
  ...
  String get multipleCalculationModesDesc =>
      '4 chế độ khác nhau: thông tin ngày, hiệu số ngày, cộng/trừ ngày, tính tuổi';
  ...
  String get detailedDateInfoDesc =>
      'Hiển thị đầy đủ thông tin về ngày: thứ, tuần, quý, năm nhuận';
  ...
  String get flexibleDateInputDesc =>
      'Hỗ trợ nhiều cách nhập ngày và điều chỉnh dễ dàng';
  ...
  String get step1DateDesc =>
      'Chọn tab phù hợp: Thông tin ngày, Hiệu số ngày, Cộng/trừ ngày, hoặc Tính tuổi';
  ...
  String get step2DateDesc =>
      'Sử dụng date picker hoặc stepper để nhập ngày cần tính toán';
  ...
  String get step3DateDesc =>
      'Kết quả sẽ được hiển thị ngay lập tức với thông tin chi tiết';
  ...
  String get step4DateDesc =>
      'Kết quả được tự động lưu vào lịch sử để tham khảo sau này';
  ...
  String get dateInfoModeDesc =>
      'Hiển thị thông tin chi tiết về một ngày cụ thể';
  ...
  String get addSubtractModeDesc =>
      'Cộng hoặc trừ số ngày/tháng/năm từ một ngày';
  ...
  String get ageCalculatorModeDesc =>
      'Tính tuổi chính xác từ ngày sinh đến hiện tại hoặc ngày khác';
  ...
  @override
  String get dateTip2 =>
      'Dùng stepper để điều chỉnh từng thành phần ngày/tháng/năm';
  ...
  @override
  String get dateTip4 =>
      'Chú ý đến năm nhuận khi tính toán các khoảng thời gian dài';

  @override
  String get dateTip5 =>
      'Sử dụng chế độ thông tin để hiểu rõ hơn về các tính năng';
  ...
  String get dateLimitationsDesc =>
      'Một số điểm cần lưu ý khi sử dụng máy tính ngày:';
  ...
  String get dateLimitation3 =>
      'Năm nhuận được tính theo quy tắc chuẩn quốc tế';

  @override
  String get dateLimitation4 =>
      'Kết quả có thể khác biệt với một số hệ thống lịch khác';

  @override
  String get dateLimitation5 =>
      'Nên kiểm tra lại kết quả cho các tính toán quan trọng';

  @override
  String get dateDisclaimer =>
      'Công cụ này cung cấp thông tin ngày tháng dựa trên lịch Gregorian tiêu chuẩn. Kết quả chỉ mang tính chất tham khảo và có thể cần xác minh thêm cho các ứng dụng quan trọng.';
  ...
  String get discountCalculatorDesc =>
      'Tính toán giảm giá, tip, thuế và lãi suất một cách nhanh chóng và chính xác';
  ...
  String get discountLimitationsDesc =>
      'Kết quả tính toán là tham khảo và có thể không phản ánh chính xác thực tế do các yếu tố khác:';
  ...
  String get discountLimitation4 =>
      'Lãi suất có thể bị ảnh hưởng bởi các chi phí khác';
  ...
  String get discountDisclaimer =>
      'Công cụ này chỉ hỗ trợ tính toán và không thay thế tư vấn tài chính chuyên nghiệp. Kết quả có thể khác thực tế do các yếu tố khác.';
  ...
  String get comprehensiveFinancialCalcDesc =>
      'Máy tính tài chính đa năng cho vay, đầu tư và lãi kép';
  ...
  String get multipleCalculationTypesDesc =>
      'Hỗ trợ tính toán vay, đầu tư và lãi kép trong một ứng dụng';
  ...
  String get realTimeResultsDesc =>
      'Nhận kết quả chi tiết ngay lập tức khi bạn nhập dữ liệu';
  ...
  String get historySavingDesc =>
      'Lưu và xem lại các phép tính trước đó để tham khảo';
  ...
  String get step1FinancialDesc =>
      'Chọn tab Vay, Đầu tư hoặc Lãi kép theo nhu cầu của bạn';
  ...
  String get step2FinancialDesc =>
      'Điền các thông tin cần thiết như số tiền, lãi suất, thời gian';
  ...
  String get loanFormulaDesc =>
      'M: Thanh toán hàng tháng, P: Số tiền vay, r: Lãi suất hàng tháng, n: Số tháng';
  ...
  String get investmentFormulaDesc =>
      'FV: Giá trị tương lai, PV: Đầu tư ban đầu, PMT: Đóng góp hàng tháng, r: Lãi suất, n: Số kỳ';
  ...
  String get compoundInterestFormulaDesc =>
      'A: Số tiền cuối cùng, P: Số tiền gốc, r: Lãi suất, n: Số lần ghép lãi/năm, t: Thời gian';
  ...
  String get financialLimitationsDesc =>
      'Kết quả tính toán chỉ mang tính chất tham khảo và có thể không phản ánh chính xác thực tế:';
  ...
  String get financialLimitation4 =>
      'Kết quả có thể khác tùy theo điều khoản thực tế';

  @override
  String get financialLimitation5 =>
      'Nên tham khảo ý kiến chuyên gia tài chính';

  @override
  String get financialDisclaimer =>
      'Công cụ này chỉ hỗ trợ tính toán và không thay thế tư vấn tài chính chuyên nghiệp. Vui lòng tham khảo chuyên gia trước khi đưa ra quyết định tài chính quan trọng.';

  @override
  String get discountResultSavedToHistory =>
      'Kết quả tính giảm giá đã lưu vào lịch sử';

  @override
  String get tipResultSavedToHistory =>
      'Kết quả tính tiền tip đã lưu vào lịch sử';
  ...
  String get markupResultSavedToHistory =>
      'Kết quả tính markup đã lưu vào lịch sử';
  ...
  String get converterToolsCacheDesc =>
      'Trạng thái tiền tệ/độ dài, các cài đặt sẵn và bộ đệm tỷ giá hối đoái';

  @override
  String get p2pDataTransferCacheDesc =>
      'Cài đặt, hồ sơ thiết bị đã lưu và bộ đệm truyền tệp tạm thời.';
  ...
  String get temporaryFilesFromTransfers =>
      'File tạm thời từ truyền file P2Lan';
  ...
  String get fileCacheClearedSuccessfully =>
      'Đã xóa bộ nhớ đệm file thành công';
  ...
  String get resetConfirmation =>
      'Bạn có chắc muốn đặt lại tất cả cài đặt về giá trị mặc định không?';
  ...
  String get clearFileCacheConfirm =>
      'Điều này sẽ xóa file tạm thời từ truyền file P2Lan. Hành động này không thể hoàn tác.';
  ...
  String get transferSettingsUpdated =>
      'Cập nhật cài đặt truyền file thành công';
  ...
  String get createSenderFoldersDescription =>
      'Sắp xếp theo tên hiển thị người gửi';
  ...
  String get grantStoragePermission =>
      'Cấp quyền lưu trữ để chọn thư mục tải về';
  ...
  String get notificationPermissionInfo =>
      'Quyền thông báo cho phép bạn nhận cập nhật về truyền file và trạng thái kết nối.';
