...
class _CoinFlipGeneratorScreenState
  ...
  Widget _buildCounterStats(
      AppLocalizations loc, CoinFlipCounterStatistics stats) {
    return Column(
      children: [
        // Start time
        _buildStatRow(
        ...
        _buildStatRow(
          ...
          label: loc.headsCount,
          value:
              '${stats.headsCount} (${stats.headsPercentage.toStringAsFixed(1)}%)',
        ...
        _buildStatRow(
          icon: Icons.cancel,
          label: loc.tailsCount,
          value:
              '${stats.tailsCount} (${stats.tailsPercentage.toStringAsFixed(1)}%)',
