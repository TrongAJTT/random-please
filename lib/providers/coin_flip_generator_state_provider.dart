...
class CoinFlipGeneratorStateManager
    extends StateNotifier<SimpleGeneratorState> {
  static const String _stateKey = 'coinFlipGeneratorState';
  final Ref ref;

  CoinFlipGeneratorStateManager(this.ref)
...
final coinFlipGeneratorStateManagerProvider =
    StateNotifierProvider<CoinFlipGeneratorStateManager, SimpleGeneratorState>(
        (ref) {
  return CoinFlipGeneratorStateManager(ref);
});
