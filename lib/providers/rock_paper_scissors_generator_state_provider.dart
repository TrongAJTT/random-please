...
class RockPaperScissorsGeneratorStateManager
    extends StateNotifier<SimpleGeneratorState> {
  static const String _stateKey = 'rockPaperScissorsGeneratorState';
  final Ref ref;

  RockPaperScissorsGeneratorStateManager(this.ref)
...
final rockPaperScissorsGeneratorStateManagerProvider = StateNotifierProvider<
    RockPaperScissorsGeneratorStateManager, SimpleGeneratorState>((ref) {
  return RockPaperScissorsGeneratorStateManager(ref);
});
